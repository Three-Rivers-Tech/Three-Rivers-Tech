        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-primary to-secondary rounded-xl shadow-lg p-8 sm:p-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
              <Link
                href="/contact"
                className="bg-white text-primary font-semibold py-3 px-6 rounded-lg hover:bg-gray-100 transition-all duration-300 text-center min-h-[48px] flex items-center justify-center"
              >
                Partner With Us
              </Link>
              <Link
                href="/learning-center"
                className="bg-white/20 backdrop-blur-sm border-2 border-white text-white font-semibold py-3 px-6 rounded-lg hover:bg-white hover:text-primary transition-all duration-300 text-center min-h-[48px] flex items-center justify-center"
              >
